    ...
    render() {
        ...
        return (
            <Paper style={paperStyle} zDepth={1}>
                <Row>
                    <Col sm={4}><h2><AdminsIcon/>Admins</h2></Col>
                    <Col sm={8} className="text-right">
                        <CircularProgress className={isLoading ? 'loading-spinner' : 'hidden'} size={36}/>
                        <RaisedButton href='#/admin/new' className='pull-right' primary={true} label='New Admin'/>
                    </Col>
                </Row>
                <hr/>
                ...
                <Filters columns={[{label: 'Name', key: 'name', type: 'string'}, {
                    label: 'Email',
                    key: 'email',
                    type: 'string'
                                ...
                                return (
                                    <TableRow key={item.id}>
                                        ...
                                        <TableRowColumn className='text-right'>
                                            ...
                                            <IconButton
                                                onTouchTap={() => location.hash = `#/admin/${item.id}`}><ActionVisibility
                                                color={palette.primary1Color}/></IconButton>
                                            <IconButton
                                                onTouchTap={() => location.hash = `#/admin/${item.id}/edit`}><ImageEdit
